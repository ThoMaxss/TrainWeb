...
export function DynamicClientTime() {
  ...
  if (!mounted) {
    return (
      <div className="flex items-center gap-2 rounded-full border bg-background/80 px-4 py-2 backdrop-blur">
  ...
  return (
    <div className="flex items-center gap-2 rounded-full border bg-background/80 px-4 py-2 backdrop-blur shadow-lg">
