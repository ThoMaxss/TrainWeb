  ...
  return (
    <header className="sticky top-0 z-[30] w-full border-b bg-card shadow-sm">
      <div className="container mx-auto flex h-14 lg:h-16 items-center justify-between px-4 gap-4">
        ...
        >
          <div className="flex h-9 w-9 lg:h-10 lg:w-10 items-center justify-center rounded-lg bg-primary">
        ...
        <div className="flex items-center gap-1 lg:gap-2">
          ...
          {isAuthenticated && user ? (
              ...
              {userMenuOpen && (
                <>
                  <div
                    ...
                    aria-hidden="true"
                  />
                  <div className="absolute right-0 top-full mt-2 w-64 rounded-lg border bg-card z-50 py-1">
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <Link href="/register">
                <Button size="sm" className="bg-primary px-6">
                  Đăng ký
                </Button>
              </Link>
            </div>
          ...
          {isAuthenticated && user ? (
            ...
            <div className="mb-4 flex flex-col gap-2">
              ...
              <Link href="/register" onClick={() => setMobileMenuOpen(false)}>
                <Button size="sm" className="w-full justify-start bg-primary">
                  Đăng ký
                </Button>
              </Link>
            </div>
