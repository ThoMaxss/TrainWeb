...
const statusConfig: Record<BadgeStatusProps['status'], string> = {
  ...
  completed: "bg-card text-foreground border-border dark:bg-card dark:text-muted-foreground dark:border-border"
};
