      ...
      <div className="container mx-auto px-2 lg:px-2 py-5">
        <div className="mx-auto max-w-4xl">
          ...
          <Tabs
            ...
            className="w-full"
          >
            <div className="sticky top-4 z-[25] bg-background pb-3">
      ...
      >
        ...
        <div
          className={cn(
            ...
            notification.isCritical && "bg-destructive/10"
          )}
        >
          ...
          <div className="flex items-start justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              {notification.isCritical && (
                <Badge className="bg-destructive text-xs hover:bg-destructive">
                  Quan trọng
                </Badge>
              )}
            </div>
