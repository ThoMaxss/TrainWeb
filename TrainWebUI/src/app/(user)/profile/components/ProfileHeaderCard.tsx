      ...
      <div className="p-6">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="relative group">
            <div className="h-24 w-24 rounded-full border-4 border-white/20 shadow-lg bg-primary flex items-center justify-center text-primary-foreground text-2xl font-bold overflow-hidden">
              {avatarPreview ? (
