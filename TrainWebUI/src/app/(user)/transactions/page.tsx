      ...
      <div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/20 dark:to-primary/10 border-b">
        <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card className="p-6 rounded-2xl border bg-card hover:shadow-lg transition-all">
            ...
            <Card className="p-6 rounded-2xl border bg-gradient-to-br from-primary to-primary/80 text-white hover:shadow-lg transition-all">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-white/80 mb-1">Tổng chi tiêu</p>
