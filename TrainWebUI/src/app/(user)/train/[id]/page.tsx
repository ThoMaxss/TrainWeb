...
export default function TrainDetailPage({ params }: TrainDetailPageProps) {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .catch((error) => {
        ...
        setError("Không thể tải dữ liệu từ server. Vui lòng kiểm tra backend đang chạy ở http://localhost:5232");
        setTrain(null);
        setTrip(null);
        setSeats([]);
      })
  ...
  if (loading) {
    return <LoadingSpinner message="Đang tải thông tin tàu..." />;
  }
            ...
            <div className="bg-primary p-2 text-primary-foreground">
              <div className="grid gap-3 md:grid-cols-3">
                ...
                <div className="flex flex-col items-center justify-center">
                  <div className="mb-2 flex items-center gap-2 rounded-full bg-background/20 px-2 py-1.5">
