...
export function ScanOverviewCard({ stats, scannedTicket, mode }: ScanOverviewCardProps) {
  return (
    <Card className="border-0 bg-gradient-to-br from-primary to-primary/90 text-primary-foreground shadow-lg rounded-2xl">
      <div className="p-6">
        ...
        <div className="grid grid-cols-3 gap-3 mt-5">
          <div className="rounded-xl bg-background/15 backdrop-blur-sm px-3 py-3">
