...
export function ProfileHeaderCard({
  ...
  return (
    <Card className="border bg-success text-primary-foreground overflow-hidden">
      <div className="p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          {/* Avatar */}
          <div className="relative group">
            <div className="h-24 w-24 rounded-full border-4 border-white/20 bg-success flex items-center justify-center text-primary-foreground text-2xl font-bold overflow-hidden">
              {avatarPreview ? (
            ...
            <button
              ...
              className="absolute bottom-0 right-0 flex h-8 w-8 items-center justify-center rounded-full bg-background text-success opacity-0 group-hover:opacity-100 transition-opacity hover:scale-110"
