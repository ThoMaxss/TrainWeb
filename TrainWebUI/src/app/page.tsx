    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative w-full h-[400px] md:h-[520px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 md:px-8 pt-16 md:pt-20">
          ...
          >
            <div className="rounded-lg border px-4 py-6 md:px-8 md:py-8">
              <SearchSection />
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            return (
              ...
              >
                <Card className="h-full border p-6 flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {[
            ...
            <motion.div
              ...
              className="flex items-center justify-center rounded-xl border border-border hover:border-primary p-6 transition-all cursor-pointer"
            >
              <Image
                src={partner.img}
                alt={partner.alt}
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-20">
          <div className="rounded-lg border p-6 md:p-8 flex flex-col md:flex-row items-center gap-8 max-w-4xl">
